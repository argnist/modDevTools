...
/**
 * Class modDevToolsBaseManagerController
 */
abstract class modDevToolsBaseManagerController extends modExtraManagerController {
	...
	public function initialize() {
		...
		$this->modDevTools = new modDevTools($this->modx, array('core_path' => $corePath));
