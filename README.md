...
modDevTools is a base Extra template that is useful when wanting to create a new
...
`git clone http://github.com/splittingred/modDevTools.git ./`

Then, create the target directory where you want to create the file.

Then, navigate to the directory modDevTools is now in, and do this:
...
Now, you'll want to change references to modDevTools in the files in your
new copied-from-modDevTools repo to whatever name of your new Extra will be. Once
...
Also, you'll want to change all the references of 'modDevTools' to whatever the
name of your component is.

## Copyright Information

modDevTools is distributed as GPL (as MODx Revolution is), but the copyright owner
(Shaun McCormick) grants all users of modDevTools the ability to modify, distribute
